...
export type ArgumentTypeMap<T extends Argument> = T['type'] extends 'string' ? string : T['type'] extends 'number' ? number : T['type'] extends 'boolean' ? boolean : T['type'] extends 'dict' ? Record<string, any> : T['type'] extends 'json' ? Json : never;
